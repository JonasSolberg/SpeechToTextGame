...
try:
    tts = gtts.gTTS("This is Australia, Mate", lang="en", tld='com.au', slow="false")
    tts.save("outputAudio.mp3")
    playsound("outputAudio.mp3")

    tts = gtts.gTTS("This is british", lang="en", tld='co.uk', slow="false")
    tts.save("outputAudio.mp3")
    playsound("outputAudio.mp3")

    tts = gtts.gTTS("This is irish Enghlish", lang="en", tld='ie', slow="false")
    tts.save("outputAudio.mp3")
    playsound("outputAudio.mp3")
